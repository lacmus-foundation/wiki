...
{% hint style="warning" %}
Данная инструкция справедлива для версий LacmusApp 0.6.x. На других версиях пользовательский интерфейс может отличаться.
{% endhint %}
...
* _**Файл**_
  ...
  * _Настройки_ - открывает окно настроек.
...
| ------- | ---------- | ------------------------------------------------------------------------------ |
| Ready   | Синий      | <ul><li>Пусто</li><li>Путь до выбранного изображения</li></ul>                 |
| Working | Ораньжевый | <ul><li>Имя выполняемой операции</li><li>Процент выполнения операции</li></ul> |
| Error   | Красный    | Сообщение об ошибке                                                            |
